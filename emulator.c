...
int
get_neighbours_of(host_t* h, host_t* neighbours)
{
...
calc_shortest_path()
{
	...
	while(1){
		...
		int num_neighbours = get_neighbours_of(&next, neighbours);
